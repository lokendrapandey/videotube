...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const existedUser = await User.findOne({
    $or: [{ username }, { email }]
  })// console.log(existedUser); // console.log(username)
...
const logoutUser = asyncHandler(async (req, res) => {
 ...
 const updateUserAvatar = asyncHandler(async(req,res)=> {
   ...
   if(!avatarLocalPath){
      ...
      return res
      .status(200)
      .json( new ApiResponse(200, "Avatart immage updated successfully"))
    })
  ...
  const updateUserCoverImage = asyncHandler(async(req,res)=> {
          ...
          return res
          .status(200)
          .json( new ApiResponse(200, "cover immage updated successfully"))
     })
